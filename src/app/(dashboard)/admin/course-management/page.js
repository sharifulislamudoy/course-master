                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <div className="p-2 rounded-lg bg-blue-50">
                                <BookOpen className="w-6 h-6 hidden md:flex text-blue-500" />
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <div className="p-2 rounded-lg bg-green-50">
                                <Check className="w-6 h-6 hidden md:flex text-green-500" />
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <div className="p-2 rounded-lg bg-purple-50">
                                <Users className="w-6 h-6 hidden md:flex text-purple-500" />
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <div className="p-2 rounded-lg bg-yellow-50">
                                <DollarSign className="w-6 h-6 hidden md:flex text-yellow-500" />
                            </div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    {currentCourses.map((course, index) => (
                        ...
                        >
                            ...
                            <div className="h-48 bg-gradient-to-r from-[#E2CC40]/20 to-[#011F2F]/20 relative">
                                ...
                                {/* Status Badge */}
                                <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-medium ${course.isPublished
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {[...Array(totalPages)].map((_, idx) => (
                                <motion.button
                                    ...
                                    className={`w-10 h-10 rounded-lg ${currentPage === idx + 1
                                    ...
                                    <form onSubmit={handleCreateCourse} className="p-6">
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <motion.button
                                                ...
                                                className={`flex-1 py-3 px-4 rounded-lg font-semibold transition-shadow ${!formData.thumbnail || uploading
                                    ...
                                    <form onSubmit={handleUpdateCourse} className="p-6">
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.95 }}
                                                disabled={uploading}
                                                className={`flex-1 py-3 px-4 rounded-lg font-semibold transition-shadow ${uploading
                                                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                                    : 'bg-gradient-to-r from-[#E2CC40] to-[#F4D03F] text-[#011F2F] hover:shadow-lg'
                                                    }`}
                                            >
